        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionId = table.Column<Guid>(type: "uuid", nullable: false),
                    SelectedAnswerOptionId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentResponses_AnswerOptions_SelectedAnswerOptionId",
                        column: x => x.SelectedAnswerOptionId,
                        principalTable: "AnswerOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentResponses_ExamSessions_ExamSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentResponses_ExamSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentResponses_SelectedAnswerOptionId",
                table: "StudentResponses",
